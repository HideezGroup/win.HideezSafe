...
namespace HideezMiddleware.DeviceConnection.Workflow.ConnectionFlow
{
    public sealed class StandaloneConnectionFlowProcessor : ConnectionFlowProcessorBase
    {
        ...
        protected override async Task MainWorkflow(ConnectionId connectionId, bool rebondOnConnectionFail, bool tryUnlock, Action<WorkstationUnlockResult> onUnlockAttempt, CancellationToken ct)
        {
            ...
            bool notificationsClearing = false;
            ...
            await WorkflowCleanup(errorMessage, connectionId, device, workflowFinishedSuccessfully, deleteVaultBondOnError, notificationsClearing);
        ...
        async Task WorkflowCleanup(string errorMessage, ConnectionId connectionId, IDevice device, bool workflowFinishedSuccessfully, bool deleteVaultBond, bool notificationsClearing)
        {
            // Cleanup
            try
            {
